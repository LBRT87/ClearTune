...
/* `/masuk` — route terpisah dari `/daftar` walau mesinnya identik.
   Privy tidak mengenal beda daftar vs masuk, tapi orang yang menekan
   "BUKA APP" datang dengan pertanyaan yang berbeda. */
